...
export const generatedMailrithMcpToolManifest = {
  "name": "mailrith",
  "manifestVersion": "1",
  "contractVersion": "v1",
  ...
  "tools": [
    ...
    },
    {
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "getPublicApiCapabilities",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
        ...
        "$defs": {
          "Capabilities": {
            ...
            "properties": {
              ...
              "sdks": {
                "$ref": "#/$defs/PublicApiSdks"
              },
              "mcp": {
                "$ref": "#/$defs/PublicApiMcp"
              },
              "conventions": {
                "type": "object",
                "required": [
              ...
              "events": {
                "$ref": "#/$defs/WebhookEventSupport"
              },
              "resources": {
                "type": "array",
                "items": {
                  "$ref": "#/$defs/CapabilityResource"
                }
              }
            }
          },
          ...
          "CapabilityOperation": {
            ...
            "properties": {
              ...
              "event_pattern_scope_requirements": {
                "$ref": "#/$defs/WebhookEventPatternScopeRequirements"
              }
            }
          },
    ...
    {
      "name": "discovery_get_open_api_document",
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "getPublicApiOpenApiDocument",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
    ...
    },
    {
      ...
      "inputSchema": {
        ...
        "properties": {
          ...
          "client": {
            "type": "string",
            "description": "Exact OAuth client identifier."
          },
          "credential_type": {
            "type": "string",
            "description": "Exact credential type."
          },
          "credential_id": {
            "type": "string",
            "description": "Exact credential identifier."
          },
          "operation": {
            "type": "string",
            "description": "Exact operation identifier."
          },
          "risk": {
            "type": "string",
            "description": "Exact risk tier."
          },
          "outcome": {
            "type": "string",
            "description": "Exact activity outcome."
          },
          "resource_type": {
            "type": "string",
      ...
      "outputSchema": {
        ...
        "properties": {
          ...
          "response": {
            "$ref": "#/$defs/AgentActivityListResponse"
          },
          "error": {
            "type": "object",
            "additionalProperties": false,
    ...
    },
    {
      ...
      "outputSchema": {
        ...
        "properties": {
          ...
          "response": {
            "$ref": "#/$defs/AgentActivityResponse"
          },
          "error": {
            "type": "object",
            "additionalProperties": false,
      ...
      "outputSchema": {
        ...
        "$defs": {
          "AnalyticsReport": {
            ...
            "description": "A 24-hour cached report with at most 100 aggregate rows, explicit definitions, freshness, attribution, and optional previous-period comparison."
          }
        }
      }
    },
    ...
    {
      "name": "diagnostics_list_automation_runs",
      ...
      "inputSchema": {
        ...
        "properties": {
          ...
          "limit": {
            ...
            "minimum": 1,
            "maximum": 50,
            "description": "Maximum run count, from 1 to 50."
          }
        },
        "required": [
          "automation_id"
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "listAutomationRunDiagnostics",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
    ...
    {
      "name": "diagnostics_get_automation_run",
      ...
      "inputSchema": {
        ...
        "properties": {
          ...
          "run_id": {
            "type": "string",
            "description": "Automation run identifier."
          }
        },
        "required": [
          "automation_id",
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "getAutomationRunDiagnostics",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
      ...
      "inputSchema": {
        ...
        "properties": {
          ...
          "limit": {
            ...
            "minimum": 1,
            "maximum": 50,
            "description": "Maximum failure count, from 1 to 50."
          }
        },
        "required": [
          "sequence_id"
    ...
    {
      "name": "diagnostics_get_broadcast",
    ...
    {
      "name": "diagnostics_get_subscriber",
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "getSubscriberActivityDiagnostics",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
    ...
    {
      "name": "subscribers_update_status",
    ...
    {
      "name": "subscribers_add_to_sequence",
    ...
    {
      "name": "subscribers_remove_from_sequence",
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "removeSubscriberSequence",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
    ...
    {
      "name": "landing_pages_list_submissions",
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "listLandingPageSubmissions",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
          ...
          "response": {
            ...
            "properties": {
              "data": {
                "type": "array",
                "items": {
                  "$ref": "#/$defs/LandingPageSubmission"
                }
              },
              "pagination": {
                "$ref": "#/$defs/Pagination"
        ...
        "$defs": {
          "Sequence": {
            ...
            "properties": {
              ...
              "is_updating": {
                "type": "boolean",
                "description": "True while Mailrith updates existing Subscriber progress after a structural Sequence change."
              },
              "connection_id": {
                "anyOf": [
                  {
                ...
                "anyOf": [
                  {
                    "allOf": [
                      {
                        "$ref": "#/$defs/BroadcastSendProgress"
                      }
                    ]
                  },
                  {
                ...
                "anyOf": [
                  {
                    ...
                    "description": "Whether the estimate uses only the current rate or also includes known provider quota windows."
                  },
                  {
                    "type": "null"
                  }
                ...
                "anyOf": [
                  {
                    ...
                    "description": "Whether the next time is a known quota reset or another connection check."
                  },
                  {
                    "type": "null"
                  }
        ...
        "$defs": {
          "Automation": {
            ...
            "properties": {
              ...
              "is_updating": {
                "type": "boolean",
                "description": "True while Mailrith updates existing Subscriber progress after a structural Automation change."
              },
              "definition": {
                "type": "object",
                "additionalProperties": true
    ...
    {
      "name": "automations_update_status",
    ...
    {
      "name": "broadcasts_get_send_progress",
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "getBroadcastSendProgress",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
    ...
    {
      "name": "broadcasts_list_delivery_errors",
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "listBroadcastDeliveryErrors",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
              ...
              "data": {
                ...
                "properties": {
                  "items": {
                    "type": "array",
                    "items": {
                      "$ref": "#/$defs/BroadcastDeliveryError"
                    }
                  },
                  "next_cursor": {
                    "anyOf": [
      ...
      "outputSchema": {
        ...
        "properties": {
          ...
          "response": {
            ...
            "properties": {
              "data": {
                "$ref": "#/$defs/BroadcastSendPreflight"
              }
            }
          },
          "error": {
        ...
        "$defs": {
          "BroadcastSendPreflight": {
            "type": "object",
            "description": "Current Subscriber estimate, provider capacity, sender and event setup health, duration estimate, and blocking issues.",
            "required": [
              "workspace_id",
              "broadcast_id",
              "subject",
            ...
            "properties": {
              ...
              "send_proof": {
                "anyOf": [
                  {
                    "type": "string",
                    "description": "Short-lived proof returned when preflight passes. Submit it unchanged to Send so Mailrith can accept the durable run without repeating the expensive Subscriber count and provider checks."
                  },
                  {
                    "type": "null"
                  }
                ...
                "anyOf": [
                  {
                    "type": "string",
                    "format": "date-time",
                    "description": "When the short-lived Send proof expires. Run preflight again after this time."
                  },
                  {
                    "type": "null"
                  }
    ...
    {
      "name": "webhook_subscriptions_get",
    ...
    },
    {
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "updateWebhookSubscription",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
    ...
    {
      "name": "webhook_subscriptions_delete",
    ...
    {
      "name": "webhook_subscriptions_rotate_secret",
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "rotateWebhookSubscriptionSecret",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
    ...
    },
    {
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "createSubscriberImportJob",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
    ...
    },
    {
      ...
      "outputSchema": {
        ...
        "properties": {
          "operation_id": {
            "type": "string",
            "const": "createSubscriberExportJob",
            "description": "The stable Mailrith public API operation ID."
          },
          "request_id": {
            "type": "string",
